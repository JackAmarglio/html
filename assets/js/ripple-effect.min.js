var RippleEffect = function (e) {
  ...
  f.position.z = 1;
  const g = new THREE.WebGLRenderer({ antialias: !1 });
  ...
  const x = new THREE.ShaderMaterial({
      uniforms: {
        time: { type: "f", value: 0 },
        image: { type: "t", value: u },
        image2: { type: "t", value: w },
        mouseOver: { type: "f", value: 0 },
        intensity: { type: "f", value: o * i },
        strength: { type: "f", value: r * i },
        area: { type: "f", value: s * i },
        waveSpeed: { type: "f", value: m * i },
      },
      vertexShader:
      ...
      (function () {
        ...
        (i = !1),
          ...
          (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
            ...
            (i = !0),
          i && ((e = "touchstart"), (n = "touchend")),
          a.addEventListener(e, function (e) {
            gsap.to(x.uniforms.mouseOver, { duration: v, value: 1, ease: d });
          }),
          a.addEventListener(n, function (e) {
            gsap.to(x.uniforms.mouseOver, { duration: c, value: 0, ease: d });
          });
      })(),
